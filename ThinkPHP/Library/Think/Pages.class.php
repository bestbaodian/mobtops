...
class Pages{
	...
	public $ulClass = 'paginations'; // 默认ul样式
     ...
     */
    public function __construct($totalRows, $listRows=20,$str='new',$ulClass='', $parameter = array()) {
        if($ulClass) {
    ...
    public function show() {
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li class="active  act"><span>' . $page . '</span></li>';
                }
            }
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class=$this->ulClass>{$page_str}</ul>";
    }
}
