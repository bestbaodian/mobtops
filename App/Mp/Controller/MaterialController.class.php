...
class MaterialController extends BaseController {
    ...
    public function text() {
        ...
        $this->addNav('文本素材', '', 'active')
             ->addNav('图片素材', U('Material/image'), '')
             ->addNav('图文素材', U('Material/news'), '')
             ->addButton('新增文本', U('Material/add?type=text'), 'btn btn-primary')
             ->assign('lists', $lists)
	...
	public function image() {
        ...
        $pagination = pagination($count, $per);
        $this->addNav('文本素材', U('Material/text'), '')
             ->addNav('图片素材', '', 'active')
             ->addNav('图文素材', U('Material/news'), '')
             ->addButton('新增图片', U('Material/add?type=image'), 'btn btn-primary')
    ...
    public function news() {
        ...
        $this->addNav('文本素材', U('Material/text'), '')
             ->addNav('图片素材', U('Material/image'), '')
             ->addNav('图文素材', '', 'active')
             ->addButton('新增图文', U('Material/add?type=news'), 'btn btn-primary')
             ->assign('lists', $lists)
             ->assign('pagination', $pagination)
             ->display();
    }
    ...
    public function add() {
        ...
        $type_arr = array('text'=>'文本','image'=>'图片','news'=>'图文');
             ...
             $this->addNav('新增'.$type_arr[$type], '', 'active');
        switch ($type) {
            case 'text':
